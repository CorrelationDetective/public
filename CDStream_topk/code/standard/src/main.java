...
public class main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        parameters.put("codeVersion", "topK");
        ...
        if (args.length > 0){
            ...
            parameters.put("k", Integer.parseInt(args[8]));

            parameters.put("topKbufferSize", 2);
            parameters.put("batchSize", 50);
            parameters.put("maxT", 500);
...
//        ----------------------------- ONESHOT SETTINGS ------------------------------------------
        ...
        parameters.put("maxApproximationSize", Math.sqrt(200 * (1- (-0.5))));
    ...
    public static ArrayList<Double> runTest(HashMap<String, Object> parameters){
        ...
        System.out.println("Running test " + algorithmType +
                "_n" + n + "_k" + k + "_w" + w + "_maxT" + maxT + "_epochSize" + epochSize);
